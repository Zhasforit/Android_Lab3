...
public class ResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editText.append(String.format("%s %s \n", getString(R.string.Ваш_цвет), getIntent().getStringExtra("color")));
        editText.append(String.format("%s %s \n", getString(R.string.Вы), getIntent().getStringExtra("robot")));
        editText.append(String.format("%s %s \n", getString(R.string.Ваша_игра), getIntent().getStringExtra("game")));
    }
